...
from PIL import Image
import os
def preprocess_images_with_padding(input_image, clean_image, target_long_side=1024):
    """
...
class QwenTextEraserPipeline:
    ...
    def load_models(self, 
        ...
        if "2509" in   pretrained_model_name_or_path:
            self.pipe = QwenImageEditPlusPipeline.from_pretrained(pretrained_model_name_or_path, torch_dtype=torch.bfloat16)
        ...
        # self.pipe.load_lora_weights("/home/v-qinhyang/code/hero_blob/preweight/Qwen/Qwen/qwenimage_edit_remover_lora/qwen-edit-remover.safetensors",weight_name="qwen-edit-remover.safetensors")
...
class QwenBenchmark:
    ...
    def run_benchmark(self):
        ...
        if "2509" in self.model_path :
            model_name = "qwen-image-edit-0925"
    ...
    def _process_single_image(self, filename, guidance_scale, output_dir):
        ...
        processed_images, processing_info = preprocess_images_with_padding(
            input_image, clean_image, target_long_side=1024
        )
        ...
        self._create_concat_image(
            input_image, result_image, clean_image,
            filename, output_dir
        )
...
def parse_args():
    ...
    parser.add_argument("--prompt", type=str, default="remove all the text in the image",
    ...
    parser.add_argument("--input_dir", type=str, default="/home/v-qinhyang/code/hero_blob/DATASET/SynthText/Syn-Text/syn_test",
                       help="Directory containing test images")
    parser.add_argument("--output_dir", type=str, default="/home/v-qinhyang/code/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_iprompt_nomask_remove",
