...
echo "========================================"
echo "Starting cluster for model 005"
...
for dataset in "${!datasets[@]}"; do
    ...
    script_path="generated_scripts/eval_005_${dataset}.sh"
    log_file="${LOG_DIR}/005_${dataset}.log"
    
    if [ -f "$script_path" ]; then
        echo "Running eval_005_${dataset}.sh on GPU ${gpu_id}..."
...
echo ""
echo "All 4 jobs for model 005 submitted"
...
echo ""
echo "========================================"
echo "Cluster for model 005 completed"
