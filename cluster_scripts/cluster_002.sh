...
echo "========================================"
echo "Starting cluster for model 002"
...
for dataset in "${!datasets[@]}"; do
    ...
    script_path="generated_scripts/eval_002_${dataset}.sh"
    log_file="${LOG_DIR}/002_${dataset}.log"
    
    if [ -f "$script_path" ]; then
        echo "Running eval_002_${dataset}.sh on GPU ${gpu_id}..."
...
echo ""
echo "All 4 jobs for model 002 submitted"
...
echo ""
echo "========================================"
echo "Cluster for model 002 completed"
