...
echo "========================================"
echo "Starting cluster for model 003"
...
for dataset in "${!datasets[@]}"; do
    ...
    script_path="generated_scripts/eval_003_${dataset}.sh"
    log_file="${LOG_DIR}/003_${dataset}.log"
    
    if [ -f "$script_path" ]; then
        echo "Running eval_003_${dataset}.sh on GPU ${gpu_id}..."
...
echo ""
echo "All 4 jobs for model 003 submitted"
...
echo ""
echo "========================================"
echo "Cluster for model 003 completed"
