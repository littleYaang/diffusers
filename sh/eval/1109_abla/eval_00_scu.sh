...
echo "Output: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_iprompt_scut_lora128_000008_scut_enstest"
...
python inference_qwen_image_edit_our.py \
    ...
    --output_dir /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_iprompt_scut_lora128_000008_scut_enstest \
...
echo "Results saved to: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_iprompt_scut_000008_lora128_scut_enstest"
