...
echo "Model: /home/v-qinhyang/code/hero_blob//preweight/Qwen/Qwen/Qwen-Image-Edit"
...
python qwen_image_removetext_eval.py \
    --model_path /home/v-qinhyang/code/hero_blob//preweight/Qwen/Qwen/Qwen-Image-Edit \
