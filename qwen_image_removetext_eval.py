...
class QwenTextEraserPipeline:
    ...
    def load_models(self, 
        ...
        if "2509" in pretrained_model_name_or_path:
            self.pipe = QwenImageEditInpaintPipeline.from_pretrained(pretrained_model_name_or_path, torch_dtype=torch.bfloat16)
            print("QwenImageEditInpaintPipeline Models loaded successfully!")
        if "Edit" in pretrained_model_name_or_path:
            self.pipe = QwenImageEditInpaintPipeline.from_pretrained(pretrained_model_name_or_path, torch_dtype=torch.bfloat16)
            print("QwenImageEditInpaintPipeline Models loaded successfully!")
        else:
            self.pipe = QwenImageInpaintPipeline.from_pretrained(pretrained_model_name_or_path, torch_dtype=torch.bfloat16)
            print("QwenImageInpaintPipeline Models loaded successfully!")
...
def parse_args():
    ...
    parser.add_argument("--prompt", type=str, default="remove the text",
    ...
    parser.add_argument("--input_dir", type=str, default="/home/v-qinhyang/code/hero_blob/DATASET/SynthText/AnyTE_bench/AnyTE-all/complex_background",
                       help="Directory containing test images")
    parser.add_argument("--output_dir", type=str, default="/home/v-qinhyang/code/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_rectmask_remove_ours_complex_background",
