#!/bin/bash
# Generated automatically - Model 000 on syn
export CUDA_VISIBLE_DEVICES=1
echo "Starting evaluation for model 000 on syn with guidance_scale=5.0"
...
echo "Output: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_syn_lora128_000_ens_syn"
...
python inference_qwen_image_edit_our.py \
    ...
    --output_dir /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_syn_lora128_000_ens_syn \
...
echo "Results saved to: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_syn_lora128_000_ens_syn"
