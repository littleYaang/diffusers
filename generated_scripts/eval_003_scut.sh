#!/bin/bash
# Generated automatically - Model 003 on scut
export CUDA_VISIBLE_DEVICES=0
echo "Starting evaluation for model 003 on scut with guidance_scale=5.0"
...
echo "Output: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_scut_lora128_003_ens_syn"
...
python inference_qwen_image_edit_our.py \
    ...
    --output_dir /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_scut_lora128_003_ens_syn \
...
echo "Results saved to: /mnt/hero_blob/TESTRESULTS/qwen_baselines/Qwen-Image-Edit2509_ablation_scut_lora128_003_ens_syn"
